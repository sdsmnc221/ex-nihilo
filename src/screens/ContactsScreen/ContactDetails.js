        ...
        <>
            <SafeAreaView>
                <View style={styles.body}>
                    <PlaceHolder color="#c4c4c4" size={200} text={firstLetter} textSize={48} round />
                    <Wrapper>
                        <Text style={styles.name}>{contact.name}</Text>
                        <AppIcon size={32} type="EDIT_CONTACTS"></AppIcon>
                    </Wrapper>
                    <Wrapper style={{justifyContent: 'space-around', marginTop: 28}}>
                        <AppIcon size={48} type="PHONE"></AppIcon>
                        <AppIcon size={48} type="SMS"></AppIcon>
                        <AppIcon size={48} type="EMAIL"></AppIcon>
                    </Wrapper>
