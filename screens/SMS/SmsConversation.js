      ...
      <SafeAreaView>
        <View style={styles.body}>
          <SmsList>
            ...
            <SmsMessage isUser message='Lorem ipsum dolor sit amet, consectetur adipiscing elit.' />

            <SmsMessage message='Lorem ipsum dolor sit amet' />
            <SmsMessage hasPlaceholder message='Lorem ipsum dolor sit amet, consectetur adipiscing elit.' />

            <Date>10:42</Date>

           <SmsMessage isUser message='Lorem ipsum dolor sit amet, consectetur adipiscing elit.' />

           <SmsMessage hasPlaceholder message='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi non arcu lobortis, lobortis ipsum et, aliquet leo.' />
          </SmsList>
          <InputField>
            <SmsInput 
              editable={false}
